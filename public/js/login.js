function submitForgotPassword(){
    document.getElementById('forgotPasswordForm').addEventListener('submit', async (e) => {
        ...
        let response = await fetch('https://residentapplication.azurewebsites.net/login/send-reset-code', {
            method: 'POST',
        ...
        if (data.success) {
            ...
            submitCodeButton.addEventListener('click', async function(e) {
                ...
                let verifyResponse = await fetch('https://residentapplication.azurewebsites.net/login/verify-reset-code', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
...
function loginButton(){
    document.getElementById('loginForm').addEventListener('submit', async (e) => {
        ...
        let response = await fetch('https://residentapplication.azurewebsites.net/login/login', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
function submitChangePassword(){
    document.getElementById('changePassword').addEventListener('submit', async (e) => {
        ...
        let response = await fetch('https://residentapplication.azurewebsites.net/login/changepassword', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
